...
RABBITMQ_SANDBOX_QUEUE = os.getenv("RABBITMQ_SANDBOX_QUEUE", "ghosttrace.sandbox.run")
RABBITMQ_X64DBG_QUEUE = os.getenv("RABBITMQ_X64DBG_QUEUE", "ghosttrace.x64dbg.requests")
